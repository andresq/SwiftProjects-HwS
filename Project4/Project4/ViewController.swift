...
//  Project4
//
//  Created by Andres Quintero on 7/24/19.
...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    var websites = ["andresq.com", "hackingwithswift.com", "apple.com"]
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        let notWebsite = "that you are trying to access"
        ...
        let ac = UIAlertController(title: "Website \(url!.host ?? notWebsite) is not allowed", message: "Please choose a proper website", preferredStyle: .alert)
